    ...
    public func download(completion: @escaping (Result<Tiktok, downloaderErrors>) -> Void) throws {
        ...
        let dataTask = URLSession.shared.dataTask(with: request) { data, response, error in
            ...
            if let data = data {
                ...
                HTTPCookieStorage.shared.setCookie(HTTPCookie(properties: [.domain: dlAddr, .path: "/", .name: "tt_webid", .value: "", .secure: "FALSE", .discard: "TRUE"])!)
                HTTPCookieStorage.shared.setCookie(HTTPCookie(properties: [.domain: dlAddr, .path: "/", .name: "tt_webid_v2", .value: "", .secure: "FALSE", .discard: "TRUE"])!)
                ...
                HTTPCookieStorage.shared.setCookie(HTTPCookie(properties: [.domain: coverAddr, .path: "/", .name: "tt_webid", .value: "", .secure: "FALSE", .discard: "TRUE"])!)
                HTTPCookieStorage.shared.setCookie(HTTPCookie(properties: [.domain: coverAddr, .path: "/", .name: "tt_webid_v2", .value: "", .secure: "FALSE", .discard: "TRUE"])!)
