...
class ProfileHeader: UICollectionReusableView {
    ...
    private let fullnamLabel: UILabel = {
        let label = UILabel()
        label.font = UIFont.boldSystemFont(ofSize: 20)
        label.text = "Viet Nguyen"
        return label
    }()
...
//        label.text = "2 Followers"
    ...
    override init(frame: CGRect) {
        ...
        addSubview(editProfileFllowButton)
        editProfileFllowButton.anchor(top: containerView.bottomAnchor, right: rightAnchor,
                                      paddingTop: 12, paddingRight: 12)
        
        editProfileFllowButton.setDimensions(width: 100, height: 36)
        editProfileFllowButton.layer.cornerRadius = 36 / 2
        
        let userDetailStack = UIStackView(arrangedSubviews: [fullnamLabel, usernameLabel, bioLabel])
    ...
    func configure() {
        ...
        editProfileFllowButton.setTitle(viewModel.actionButtonTitle, for: .normal)
